...
public final class Keys {
        ...
        /**
         * Network interface for a the protocol. If not specified, server will bind all
         * interfaces.
         */
        ...
        /**
         * Port number for the protocol. Most protocols use TCP on the transport layer.
         * Some protocols use UDP. Some
         ...
         * separated by commas. Used only for polling
         * protocols.
         */
         ...
         * detect lost TCP connection old
         * connections stay in open state. On most systems there is a limit on number of
         * open connection, so this leads to
         * problems with establishing new connections when number of devices is high or
         * devices data connections are
         * unstable.
         */
        ...
        /**
         * Enable extended functionality for the protocol. The reason it's disabled by
         * default is that not all devices
         * support it.
         */
        ...
        /**
         * Enable CAN decoding for the protocol. Similar to 'extended' configuration,
         * it's not supported for some devices.
         */
        ...
        /**
         * Indicates whether server acknowledgement is required. Only applicable for
         * some protocols.
         */
        ...
        /**
         * Ignore device reported fix time. Useful in case some devices report invalid
         * time. Currently only available for
         * GL200 protocol.
         */
        ...
        /**
         * Device time zone. Most devices report UTC time, but in some cases devices
         * report local time, so this parameter
         * needs to be configured for the server to be able to decode the time
         * correctly.
         */
         ...
         * information is the same you can see on the
         * statistics screen in the web app. It does not include any sensitive (e.g.
         * locations).
         */
        ...
        /**
         * Fuel drop threshold value. When fuel level drops from one position to another
         * for more the value, an event is
         * generated.
         */
        ...
        /**
         * Fuel increase threshold value. When fuel level increases from one position to
         * another for more the value, an
         * event is generated.
         */
        ...
        /**
         * Relevant only for geofence speed limits. Use the lowest speed limit from all
         * geofences.
         */
        ...
        /**
         * Global polyline geofence distance. Within that distance from the polyline,
         * point is considered within the
         * geofence. Each individual geofence can also has 'polylineDistance' attribute
        ...
        /**
         * Path to the database driver JAR file. Traccar includes drivers for MySQL,
         * PostgreSQL and H2 databases. If you use
        ...
        /**
         * Database driver Java class. For H2 use 'org.h2.Driver'. MySQL driver class
         * name is 'com.mysql.jdbc.Driver'.
         */
        ...
        /**
         * SQL query to check connection status. Default value is 'SELECT 1'. For Oracle
        ...
        /**
         * Store original HEX or string data as "raw" attribute in the corresponding
         * position.
         */
         ...
         * device. This flag allows to disable that
        ...
        /**
         * Device limit for self registered users. Default value is -1, which indicates
         * no limit.
         */
        ...
        /**
         * LDAP server URL. For more info check
         * <a href="https://www.traccar.org/ldap/">LDAP config</a>.
         */
        ...
        /**
         * LDAP custom search filter. If not specified, '({idAttribute}=:login)' will be
         * used as a filter.
         */
        ...
        /**
         * Force OpenID Connect authentication. When enabled, the Traccar login page
         * will be skipped
         ...
         * This is a unique ID assigned to each application you register with your
         * identity provider.
         ...
         * This is a secret assigned to each application you register with your identity
         * provider.
         * Required to enable SSO.
         */
         ...
         * This is used to automatically configure the authorization, token and user
         * info URLs if provided.
         */
         ...
         * This can usually be found in the documentation of your identity provider or
         ...
         * changes from online to unknown. Value is
        ...
        /**
         * List of protocol names to ignore offline status. Can be useful to not trigger
         * status change when devices are
        ...
        /**
         * Path to the media folder. Server stores audio, video and photo files in that
         * folder. Sub-folders will be
        ...
        /**
         * Optional parameter to specify network interface for web interface to bind to.
         * By default server will bind to all
        ...
        /**
         * Web interface TCP port number. By default Traccar uses port 8082. To avoid
         * specifying port in the browser you
        ...
        /**
         * Maximum API requests per second. Above this limit requests and delayed and
         * throttled.
         */
        ...
        /**
         * Sanitize all strings returned via API. This is needed to fix XSS issues in
         * the old web interface. New React-based
        ...
        /**
         * Path to a folder with overrides. It can be used for branding to keep custom
         * logos in a separate place.
         */
        ...
        /**
         * Enable database access console via '/console' URL. Use only for debugging.
        ...
        /**
         * Server debug version of the web app. Not recommended to use for performance
         * reasons. It is intended to be used
        ...
        /**
         * A token to login as a virtual admin account. Can be used to restore access in
         * case of issues with regular admin
        ...
        /**
         * Position forwarding format. Available options are "url", "json" and "kafka".
         * Default is "url".
         */
         ...
         * {uniqueId} for device identifier,
         ...
         * made to deliver positions. If initial
         * delivery fails, because of an unreachable server or an HTTP response
         * different from '2xx', the software waits
         * for 'forward.retry.delay' milliseconds to retry delivery. On subsequent
         * failures, this delay is duplicated.
         * If forwarding is retried for 'forward.retry.count', retrying is canceled and
         * the position is dropped. Positions
         * pending to be delivered are limited to 'forward.retry.limit'. If this limit
         * is reached, positions get discarded.
         */
        ...
        /**
         * Events forwarding format. Available options are "json" and "kafka". Default
         * is "json".
         */
        ...
        /**
         * Log emails instead of sending them via SMTP. Intended for testing purposes
         * only.
         */
        ...
        /**
         * Restrict global SMTP configuration to system messages only (e.g. password
         * reset).
         */
         ...
         * support the STARTTLS command, or the
        ...
        /**
         * If set to "*", all hosts are trusted. If set to a whitespace separated list
         * of hosts, those hosts are trusted.
        ...
        /**
         * SMS API authorization header value. This value takes precedence over user and
         * password.
         */
        ...
        /**
         * SMS API body template. Placeholders {phone} and {message} can be used in the
         * template.
        ...
        /**
         * Maximum time period for reports in seconds. Can be useful to prevent users to
         * request unreasonably long reports.
        ...
        /**
         * Gaps of more than specified time are counted as stops. Default value is one
         * hour.
         */
        ...
        /**
         * Ignore odometer value reported by the device and use server-calculated total
         * distance instead. This is useful
         ...
         * values, but it practice it usually
        ...
        /**
         * Filter messages that do not have GPS location. If they are not filtered, they
         * will include the last known
         * location.
         */
         ...
         * seconds. Records that have fix time more
         * than the specified number of seconds later than current server time would be
         * filtered out.
         */
        ...
        /**
         * Filter records with fix time in the past. The value is specified in seconds.
         * Records that have fix time more
         * than the specified number of seconds before current server time would be
         * filtered out.
         */
         ...
         * position is less far than this value
         ...
         * to far locations even if Position
         * appears valid or if Position `speed` field reported by the device is also
         * within limits. Calculates speed from
        ...
        /**
         * If false, the server expects all locations to come sequentially (for each
         * device). Filter checks for duplicates,
         * distance, speed, or time period only against the location that was last
         * received by server.
         * If true, the server expects locations to come at random order (since tracking
         * device might go offline).
         * Filter checks for duplicates, distance, speed, or time period against the
        ...
        /**
         * Time limit for the filtering in seconds. If the time difference between the
         * last position was received by server
         * and a new position is received by server is more than this limit, the new
         * position will not be filtered out.
         */
         ...
         * If position contains any attribute mentioned in "filter.skipAttributes"
        ...
        /**
         * List of protocols to enable. If not specified, Traccar enabled all protocols
         * that have port numbers listed.
         ...
         * globally. List consist of protocol
         ...
         * 'coordinates.minError' meters
         * or more than a 'coordinates.maxError' meters. Helps to avoid coordinates
         * jumps during parking period
         ...
         * 'coordinates.filter', but only if
         ...
         * Might be useful if device doesn't
        ...
        /**
         * List of attributes to copy. Attributes should be separated by a comma without
         * any spacing.
         ...
         * By default (if the value is not
         ...
         * request. If distance is less than
         ...
         * information and WiFi point when GPS
         * location is not available. Traccar can determine coordinates based on that
         * information using third party
         ...
         * opencellid. By default opencellid is
         * used. You have to supply a key that you get from corresponding provider. For
         * more information see LBS geolocation
         * documentation.
         */
        ...
        /**
         * Boolean flag to enable speed limit API to get speed limit values depending on
         ...
         * because of device bug. Value can be
         ...
         * incorrect because of device bug. Value can
         ...
         * actual date when creating and rolling
         * over the file.
        ...
        /**
         * Public URL for the web app. Used for notification, report link and OpenID
         * Connect.
         * If not provided, Traccar will attempt to get a URL from the server IP
         * address, but it might be a local address.
         */
        ...
        /**
         * Log file name. For rotating logs, a date is added at the end of the file name
         * for non-current logs.
         */
         ...
         * Available options: off, severe, warning, info, config, fine, finer, finest,
         * all.
         */
         ...
         * downloading and cleaning logs. Enabled by
         * default.
         */
